...
public class CalculadoraUTN {
    ...
    private static void ejecutarOperacion(int operacion, Scanner entrada){
        ...
        switch (operacion) {
            ...
            case 2 -> { //Resta
                resultado = operando1 - operando2;
                System.out.printf("Resultado de la resta: " + resultado);
            }
            case 3 -> { //Multiplicacion
                resultado = operando1 * operando2;
                System.out.println("Reaultado de la multiplicacion: " + resultado);
            }
            case 4 -> { //Division
                resultado = operando1 / operando2;
                System.out.println("Resiultado de la division: " + resultado);
            }
